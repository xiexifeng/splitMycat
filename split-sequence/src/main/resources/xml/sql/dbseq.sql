...
DROP TABLE IF EXISTS SEQUENCE_DETAIL;
CREATE TABLE SEQUENCE_DETAIL (  
name VARCHAR(64) NOT NULL comment '序列号名称',  
prefix_no varchar(20) NOT NULL comment '序列号前缀 可以使用通配符 如 B${yyyyMMdd}',  
seq_length INT NOT NULL DEFAULT 1 comment '序列号长度', 
seq_desc varchar(50) null comment '序列号描述',
create_time datetime null comment '创建时间',
update_time datetime null comment '修改时间',
PRIMARY KEY (name) 
) ENGINE=InnoDB comment='序列号详细配置';
